...
const client = makeWASocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC Simple By Ranz", "Dekstop", "3.0"]})
console.log(color('[ SC BY RANZMODS ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : PUSHKONTAK\n➸ Creator : RANZ\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : GA ADA`\n➸ My Instagram : @ranzmods55\n\nDonase Me For Support :\n➸ DONASI : 081212742267\n\nThanks\n', 'red'))
