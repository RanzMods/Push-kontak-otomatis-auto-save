...
✅ WAJIB MENGGUNAKAN JASA ADMIN *RANZ STORE* SUPAYA TERHINDAR DARI PENIPUAN  !
✅ BE SMART BUYYER`
reply(teks938)
}
break
case "payment": {
teks137 = "*🔰PAYMENT RanzBotz⚡*\n```SEMUA PEMBAYARAN\nWAJIB MENYERTAKAN BUKTI TRANSFER !!```\n*_( ALL TRX NO REFF‼️ )_*\n\n*• GOPAY 💳 :* 0895630227890\n```( ATAS NAMA: RanzMods )```\n\n*• DANA 💳 :*```0895630227890\n( ATAS NAMA: MUHAMMAD RAFI AL AKBAR )```\n\n*• OVO 💳 :*```0895630227890\n( ATAS NAMA: RANZMODS )```\n\n*• SHOPPE PAY 💳 :*```0895630227890\n( ATAS NAMA: RADJA RAMADHAN )```\n\n*• QRIS 💳 :*_('./qris.jpg')_\n```( ATAS NAMA: RANZ BOT )```\n\n*© RanzBotz ⚡*"
reply(teks137)
}
break
case "donasi": {
